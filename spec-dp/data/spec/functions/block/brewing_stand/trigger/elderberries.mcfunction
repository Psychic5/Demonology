...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.0 loot spec:item/wine
...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.1 loot spec:item/wine
scoreboard players reset @s spec.temp
...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.2 loot spec:item/wine
scoreboard players reset @s spec.temp