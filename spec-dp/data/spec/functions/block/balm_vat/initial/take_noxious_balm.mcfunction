...
tag @s add spec.interact.take_noxious_balm
tag @s add spec.interact.player
advancement revoke @s only spec:technical/block/balm_vat/take_noxious_balm
function spec:block/balm_vat/interact/start
tag @s remove spec.interact.bottle
tag @s remove spec.interact.take_noxious_balm
