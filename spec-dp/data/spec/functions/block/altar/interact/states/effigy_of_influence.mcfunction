...
loot replace entity @e[tag=spec.block.altar,sort=nearest,limit=1] weapon.mainhand loot spec:item/effigy_of_influence
summon item ~ ~ ~ {NoGravity:1b,Age:-32768,Tags:["spec.misc.altar.item","spec.tag.altar.effigy_of_influence"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:7131009}}}
