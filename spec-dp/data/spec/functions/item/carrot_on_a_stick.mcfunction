...
execute if predicate spec:item/holding/statue_altar run function spec:block/statue_altar/place/start

execute if predicate spec:item/holding/abyssal_scripture run function spec:item/language/abyssal_scripture
execute if predicate spec:item/holding/celestial_scripture run function spec:item/language/celestial_scripture
