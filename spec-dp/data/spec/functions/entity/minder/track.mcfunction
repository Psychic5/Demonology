...
execute as @s[tag=!spec.entity.minder.animations.spawn,tag=!spec.entity.minder.animations.attack] if entity @e[distance=..2,predicate=spec:entity/has_soul] run function spec:entity/minder/animations/attack/start