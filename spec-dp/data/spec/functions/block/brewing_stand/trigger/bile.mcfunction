...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.0 loot spec:item/embalming_fluid
...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.1 loot spec:item/embalming_fluid
scoreboard players reset @s spec.temp
...
execute if score @s spec.temp matches 1 run loot replace block ~ ~ ~ container.2 loot spec:item/embalming_fluid
scoreboard players reset @s spec.temp