...
loot replace entity @e[tag=spec.block.altar,sort=nearest,limit=1] weapon.mainhand loot spec:item/idol_of_agony
summon item ~ ~ ~ {NoGravity:1b,Age:-32768,Tags:["spec.misc.altar.item","spec.tag.altar.idol_of_agony"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:7131008}}}
