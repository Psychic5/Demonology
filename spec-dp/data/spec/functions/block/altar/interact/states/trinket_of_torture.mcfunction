...
loot replace entity @e[tag=spec.block.altar,sort=nearest,limit=1] weapon.mainhand loot spec:item/trinket_of_torture
summon item ~ ~ ~ {NoGravity:1b,Age:-32768,Tags:["spec.misc.altar.item","spec.tag.altar.trinket_of_torture"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:7131010}}}
